    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <motion.div
          ...
          className="lg:col-span-2 app-card p-4 sm:p-6 flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-white via-stone-50 to-amber-50/40 dark:from-stone-900 dark:via-stone-900 dark:to-amber-950/20"
        >
          <div className="space-y-2 z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="app-pill bg-amber-50 text-amber-900 dark:bg-amber-950 dark:text-amber-200 border-amber-200 dark:border-amber-800 text-[10px] sm:text-xs">
                  <Flame className="w-3 h-3 text-[#9A2D22]" />
                  Live Table Engine
                </span>
                <span className="app-pill bg-amber-100/70 text-[#9A2D22] dark:bg-amber-900/60 dark:text-[#FEE248] border-amber-300 text-[10px] sm:text-xs">
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight text-stone-900 dark:text-stone-50">
              {language === 'en' ? 'Reserve. Order Live. Dine.' : 'Table Book Karein. Live Order Dein.'}
            </h1>

            <p className="text-[11px] sm:text-xs text-stone-600 dark:text-stone-300 max-w-xl line-clamp-2">
              {language === 'en'
          ...
          <div className="pt-3 sm:pt-4 z-10">
            <div className="relative flex items-center bg-white dark:bg-stone-800 rounded-xl border border-stone-200 dark:border-stone-700 shadow-2xs focus-within:border-[#9A2D22]">
              ...
              <input
                ...
                className="w-full px-2.5 py-2 text-xs sm:text-sm text-stone-900 dark:text-stone-100 placeholder-stone-400 bg-transparent outline-none"
              />
              {searchQuery ? (
                <button
                  onClick={() => setSearchQuery('')}
                  className="px-3 text-xs text-stone-400 hover:text-stone-700 font-bold cursor-pointer"
                >
                  Clear
                </button>
              ) : (
                <div className="mr-2 px-2 py-0.5 bg-stone-100 dark:bg-stone-700 rounded-lg text-[10px] font-bold text-stone-500 dark:text-stone-300">
                  Search
                </div>
              )}
            </div>
          ...
          <div className="absolute right-0 bottom-0 opacity-5 pointer-events-none transform translate-x-4 translate-y-4">
            <Utensils className="w-44 h-44 text-[#9A2D22]" />
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-amber-50 dark:bg-amber-950/60 text-[#9A2D22] dark:text-[#FEE248] rounded-xl flex items-center justify-center font-bold">
              <Star className="w-5 h-5 fill-[#E5A324] text-[#E5A324]" />
            </div>
            <div>
          ...
          <div className="text-[11px] text-stone-400 flex items-center justify-between border-t border-stone-100 dark:border-stone-800 pt-2.5">
            ...
            <span className="font-bold text-[#9A2D22] dark:text-[#FEE248]">4.8+ Avg</span>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#83241A] to-[#9A2D22] rounded-2xl shadow-sm p-5 flex flex-col justify-between text-white"
        >
          <div className="flex items-center justify-between">
            <div className="w-10 h-10 shrink-0">
              <DastnayLogo variant="tile" size="xs" rounded="lg" />
            </div>
            <span className="px-2.5 py-0.5 rounded-full bg-white/20 text-[10px] font-extrabold uppercase tracking-wider text-[#FEE248]">
              dastnay Rewards
            </span>
          </div>
          ...
          <div className="w-full bg-white/10 rounded-xl p-2 flex items-center justify-between text-xs font-semibold">
            ...
            <span className="font-bold text-[#FEE248]">100 pts = Rs. 50</span>
          </div>
        </motion.div>
      </div>
        ...
        {filteredRestaurants.map((rest, index) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -3 }}
              key={rest.id}
              className="app-card overflow-hidden flex flex-col group hover:border-[#9A2D22]/50 dark:hover:border-[#E5A324]/50 hover:shadow-md transition-all"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-xs text-stone-500 dark:text-stone-400">
                    <span className="font-semibold text-[#9A2D22] dark:text-[#FEE248]">
                      {rest.cuisine.join(' • ')}
                    </span>
                  ...
                  <div className="flex items-start gap-2 text-xs text-stone-600 dark:text-stone-300">
                    <MapPin className="w-4 h-4 text-[#9A2D22] dark:text-[#E5A324] shrink-0 mt-0.5" />
                    <div>
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-stone-900 dark:bg-stone-100 hover:bg-[#9A2D22] dark:hover:bg-[#9A2D22] text-white dark:text-stone-900 hover:text-white dark:hover:text-white text-xs font-bold transition-all shadow-xs cursor-pointer group-hover:bg-[#9A2D22] group-hover:text-white"
                >
